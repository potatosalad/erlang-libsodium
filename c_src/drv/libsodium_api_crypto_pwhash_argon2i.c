...
libsodium_function_t	libsodium_functions_crypto_pwhash_argon2i[] = {
	LS_API_R_ARG0(crypto_pwhash_argon2i, alg_argon2i13),
...
LS_API_EXEC(crypto_pwhash_argon2i, crypto_pwhash_argon2i)
{
	...
	LS_SAFE_REPLY(crypto_pwhash_argon2i(out, argv->outlen, argv->passwd, argv->passwdlen, argv->salt, argv->opslimit, argv->memlimit, argv->alg), LS_PROTECT({
		LS_RES_TAG(request),
