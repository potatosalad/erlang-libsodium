...
LS_API_INIT(crypto_pwhash_scryptsalsa208sha256, crypto_pwhash_scryptsalsa208sha256)
{
	...
	x = (ErlDrvSizeT)(passwdlen + (sizeof (LS_API_F_ARGV_T(crypto_pwhash_scryptsalsa208sha256, crypto_pwhash_scryptsalsa208sha256))));
...
LS_API_EXEC(crypto_pwhash_scryptsalsa208sha256, crypto_pwhash_scryptsalsa208sha256)
{
	...
	LS_SAFE_REPLY(crypto_pwhash_scryptsalsa208sha256(out, argv->outlen, argv->passwd, argv->passwdlen, argv->salt, argv->opslimit, argv->memlimit), LS_PROTECT({
		LS_RES_TAG(request),
...
LS_API_EXEC(crypto_pwhash_scryptsalsa208sha256, ll)
{
	...
	LS_SAFE_REPLY(crypto_pwhash_scryptsalsa208sha256_ll(argv->passwd, argv->passwdlen, argv->salt, argv->saltlen, argv->N, argv->r, argv->p, buf, argv->buflen), LS_PROTECT({
		LS_RES_TAG(request),
		ERL_DRV_BUF2BINARY, (ErlDrvTermData)(buf), argv->buflen,
		ERL_DRV_TUPLE, 2
	}), __FILE__, __LINE__);
