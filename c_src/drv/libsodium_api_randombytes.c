...
libsodium_function_t	libsodium_functions_randombytes[] = {
...
LS_API_EXEC(randombytes, buf)
{
	...
	ErlDrvTermData spec[] = {
		LS_RES_TAG(request),
		ERL_DRV_BUF2BINARY, (ErlDrvTermData)(buf), argv->size,
		ERL_DRV_TUPLE, 2
	};
...
LS_API_EXEC(randombytes, implementation_name)
{
	...
	ErlDrvTermData spec[] = {
		LS_RES_TAG(request),
		ERL_DRV_ATOM, driver_mk_atom((char *)(implementation_name)),
		ERL_DRV_TUPLE, 2
	};
...
LS_API_EXEC(randombytes, randombytes)
{
	...
	ErlDrvTermData spec[] = {
		LS_RES_TAG(request),
		ERL_DRV_BUF2BINARY, (ErlDrvTermData)(buf), (ErlDrvUInt)(argv->buf_len),
		ERL_DRV_TUPLE, 2
	};
