...
libsodium_function_t	libsodium_functions_crypto_stream[] = {
	LS_API_R_ARG0(crypto_stream, keybytes),
	LS_API_R_ARG0(crypto_stream, noncebytes),
	LS_API_R_ARG0(crypto_stream, primitive),
	LS_API_R_ARGV(crypto_stream, crypto_stream, 3),
	LS_API_R_ARGV(crypto_stream, xor, 3),
	{NULL}
};
