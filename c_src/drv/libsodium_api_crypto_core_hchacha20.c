...
static void LS_API_EXEC(crypto_core_hchacha20, outputbytes);
static void LS_API_EXEC(crypto_core_hchacha20, inputbytes);
static void LS_API_EXEC(crypto_core_hchacha20, keybytes);
static void LS_API_EXEC(crypto_core_hchacha20, constbytes);
static int LS_API_INIT(crypto_core_hchacha20, crypto_core_hchacha20);
...
static void
LS_API_EXEC(crypto_core_hchacha20, outputbytes)
{
    size_t outputbytes;

    outputbytes = crypto_core_hchacha20_outputbytes();
...
/* crypto_core_hchacha20_inputbytes/0 */

static void
LS_API_EXEC(crypto_core_hchacha20, inputbytes)
{
    size_t inputbytes;

    inputbytes = crypto_core_hchacha20_inputbytes();
...
/* crypto_core_hchacha20_keybytes/0 */

static void
LS_API_EXEC(crypto_core_hchacha20, keybytes)
{
    size_t keybytes;

    keybytes = crypto_core_hchacha20_keybytes();
...
/* crypto_core_hchacha20_constbytes/0 */

static void
LS_API_EXEC(crypto_core_hchacha20, constbytes)
{
    size_t constbytes;

    constbytes = crypto_core_hchacha20_constbytes();
...
/* crypto_core_hchacha20_crypto_core_hchacha20/2 */

typedef struct LS_API_F_ARGV(crypto_core_hchacha20, crypto_core_hchacha20) {
    const unsigned char *in;
    const unsigned char *k;
    const unsigned char *c;
} LS_API_F_ARGV_T(crypto_core_hchacha20, crypto_core_hchacha20);

static int
LS_API_INIT(crypto_core_hchacha20, crypto_core_hchacha20)
{
    LS_API_F_ARGV_T(crypto_core_hchacha20, crypto_core_hchacha20) * argv;
    int skip;
    int type;
    int type_length;
    size_t inputbytes;
    ...
    x = (ErlDrvSizeT)(inputbytes + keybytes + constbytes + (sizeof(LS_API_F_ARGV_T(crypto_core_hchacha20, crypto_core_hchacha20))));
    ...
    argv = (LS_API_F_ARGV_T(crypto_core_hchacha20, crypto_core_hchacha20) *)(p);
    p += (sizeof(LS_API_F_ARGV_T(crypto_core_hchacha20, crypto_core_hchacha20)));
...
static void
LS_API_EXEC(crypto_core_hchacha20, crypto_core_hchacha20)
{
    LS_API_F_ARGV_T(crypto_core_hchacha20, crypto_core_hchacha20) * argv;
    LS_API_READ_ARGV(crypto_core_hchacha20, crypto_core_hchacha20);
    size_t outputbytes;
    unsigned char *out;
    ...
    (void)crypto_core_hchacha20(out, argv->in, argv->k, argv->c);
