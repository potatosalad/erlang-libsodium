...
%%%-------------------------------------------------------------------
-module(libsodium_crypto_core_salsa20).

-define(NAMESPACE, crypto_core_salsa20).
...
crypto_core_salsa20(In, K, C)
		when is_binary(In)
		andalso is_binary(K)
		andalso is_binary(C) ->
	call(crypto_core_salsa20, {In, K, C}).
